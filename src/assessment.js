...
function Burrito(meat, bean){
  this.percentLeft = 100;
  this.eat = function(){
    return	this.percentLeft = this.percentLeft - 25;
  };
}
...
function Chimichanga(meat){
  this.percentLeft = 100;
  this.eat = function(){
    return	this.percentLeft = this.percentLeft - 20;
  };
}
...
function sentenceMachine(partOne){
	return sentenceSmasher = function(partTwo){
